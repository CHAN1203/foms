...
public class ManagerView extends MainView{
        ...
        do {
            ...
            switch (opt) {
                ...
                case 3:
                    ...
                    System.out.printf("Enter price of %s:\n\r", name);
                    price = Helper.readDouble();
                    updateMenuItem(name, description, price, category);
                    break;
                case 4:
	...
	private void addMenuItem(String name, String description, double price, FileType category){

        if (ManagerController.addMenuItem(name, description, price, category)){
	...
	private void updateMenuItem(String name, String description, double price, FileType category) {
        if (ManagerController.updateMenuItem(name, description, price, category)) {
