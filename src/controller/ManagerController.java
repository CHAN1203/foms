...
public class ManagerController extends StaffManager{
	...
	public static boolean addMenuItem(String name, String description, double price, FileType category) {
        ...
        Repository.saveFileIntoDatabase(FileType.MENU_ITEMS);
        return true;
	}
	
	public static boolean updateMenuItem(String name, String description, double price, FileType category){
        String formattedName = name.toUpperCase();
        ...
        menuItemToUpdate.setMenuCategory(category);
        //!!
        Repository.saveFileIntoDatabase(FileType.MENU_ITEMS);
        return true;
    }
